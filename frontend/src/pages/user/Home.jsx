        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-10 sm:mb-14">
            <div>
              ...
              <p
                className="editorial-title text-3xl sm:text-5xl md:text-6xl sr visible sr-d1"
            ...
            {products.map((item, i) => (
              ...
              >
                ...
                <div className="relative overflow-hidden aspect-[4/5] bg-gray-50 shrink-0">
                  ...
                  {/* Explore Button */}
                  <div
                    className="absolute bottom-5 left-1/2 -translate-x-1/2 translate-y-6 opacity-0 
group-hover:translate-y-0 group-hover:opacity-100 
transition-all duration-500 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] z-10"
                  >
                    <button
                      onClick={(e) => e.stopPropagation()}
                      className="relative overflow-hidden text-[11px] tracking-[0.15em] uppercase 
  text-white border border-white/40 px-6 py-2.5 
  transition-all duration-300 cursor-pointer group/explore"
                    >
                      {/* Animated background */}
                      <span
                        className="absolute inset-0 bg-white scale-x-0 origin-left 
  transition-transform duration-300 group-hover/explore:scale-x-100"
                      ></span>

                      {/* Text */}
                      <span className="relative z-10 group-hover/explore:text-black transition-colors duration-300">
                        More Details
                      </span>
                    </button>
                  </div>
