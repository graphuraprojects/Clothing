...
/* HERO TEXT */
  const TITLE_TEXT = "Grace in Every Detail.";
  const SUB_TEXT =
    "Timeless ethnic, modern western and elegant styles for every woman, every mood";
...
export default function WomenCollection() {
  ...
  const loadProducts = async () => {
    try {
      ...
      const uniqueCats = [
        ...new Set(
          womenProducts.map(p => p.category?.name?.toLowerCase())
        ),
      ].filter(Boolean);
    ...
    <div className="bg-[#faf7f2] min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg font-medium">Discover styles that match your personality</p>
          <div className="flex justify-center mt-6">
            <div className="h-1 w-24 bg-gradient-to-r from-rose-500 to-rose-600 rounded-full" />
          </div>
        </div>
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-6 text-white">
                  <div className="transform translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-2 bg-white text-gray-900 font-semibold py-3 px-8 rounded-full hover:bg-rose-50 transition-all duration-300 shadow-md hover:shadow-lg hover:scale-105"
                    >
            ...
            className={`
              ...
              ${
                gender === g
                  ...
                  : "bg-gray-50 text-gray-700 border-gray-200 hover:border-rose-300 hover:bg-rose-50"
              }
            `}
          >
            {g.toUpperCase()}
